angular.module('welcomeApp', ['dataGrid', 'pagination','ngMaterial','ngMessages','ngFileUpload'])
    	...
    	$scope.metodoSession= function(teste)
                              {
                                 ...
                                 var request = $http({
                                     method:'POST',
                                     url:'../hirts/controller/WelcomeController.php',
                                     data:teste
                                 });
                                 request.then(
                                                function(response)
        ...
        $scope.uploadFilesPerfil = function(file,errFiles){
            ...
            file.upload = Upload.upload({
                url:"../hirts/controller/UploadController.php",
                data:{file:file}
            });
        ...
        $scope.uploadFilesUsuario = function(file,errFiles){
            //console.log(file);
            file.upload = Upload.upload({
                url:"../hirts/controller/UploadUsuarioController.php",
    ...
    $scope.excluirUsuarioData = function(item){
            ...
            var request = $http({
                                     method:'POST',
                                     url:'../hirts/controller/ExcluirUsuarioController.php',
                                     data:item
                                 });
                                 request.then(
                                                function(response)
    ...
    $scope.atualizarUsuarioData = function(item){
            ...
            var request = $http({
                                     method:'POST',
                                     url:'../hirts/controller/AtualizarUsuarioController.php',
                                     data:item
                                 });
                                 request.then(
                                                function(response)
    ...
    $scope.atualizarPerfilData = function(){
            ...
            var request = $http({
                                     method:'POST',
                                     url:'../hirts/controller/AtualizarPerfilController.php',
                                     data:$scope.sessao
                                 });
                                 request.then(
                                                function(response)
    ...
    $scope.logout = function(teste){
            var request = $http({
                                     method:'POST',
                                     url:'../hirts/controller/LogoutController.php',
                                     data:teste
                                 });
                                 request.then(
                                                function(response)
                                                {
                                                 console.log(response.data);
                                                 $scope.sessao = response.data;
                                                 $window.location.href = 'http://localhost/hirts';
                                                },
                                                function(error)
                                                {
    ...
    $scope.lista = function(){
            var request = $http({
                                     method:'POST',
                                     url:'../hirts/controller/ListarUsuariosController.php'
                                 });
            request.then(
                           function(response)
                           {
